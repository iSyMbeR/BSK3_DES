...
public class DES {
    ...
    public static String[] encrypt(String message, String[] subKey) {
        ...
        for (StringBuilder x : blocksOfMessage) {
            ...
            encryptedMessage[i++] = runDesEncrypt(x.toString(), subKey);
        }
        return encryptedMessage;
    }

    public static String runDesEncrypt(String message, String[] subKey) {
    ...
    public static String runDesDecrypt(String message, String[] subKey) {
        ...
        System.out.println("Po validacji : "+message);
        StringBuilder plainText = new StringBuilder(message);
        StringBuilder encryptedText = new StringBuilder();
        StringBuilder leftSide = new StringBuilder();
        StringBuilder rightSide = new StringBuilder();
